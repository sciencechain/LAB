...
uint256 hashGenesisBlock("0x0000020c1385d5fa12e186135acafc54e70c537765d1c3c7339f4cc8324b6ed5");
static const unsigned int timeGenesisBlock = 1401578118;
...
const string strMessageMagic = "Coinlabcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Coinlab.info";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x3aa02df512f1a9dd89f81956951947269404a930315453f0dd8dab996eda1f1a"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CoinlabcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CoinlabcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running CoinlabcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("CoinlabcoinMiner terminated\n");
        throw;
    }
}
