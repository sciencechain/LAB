...
// Copyright (c) 2013-2015 The Sciencechaincoin developers
...
#if defined(NDEBUG)
# error "Sciencechain cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Sciencechaincoin Signed Message:\n";
