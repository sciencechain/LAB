...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LAB");
    case cBTC: return QString("cLAB");
    case mBTC: return QString::fromUtf8("mLAB");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Sciencechain");
    case cBTC: return QString("Centum-Sciencechain (1 / 100)");
    case mBTC: return QString("Milli-Sciencechain (1 / 1,000)");
    default: return QString("???");
    }
}
