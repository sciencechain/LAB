...
!define COMPANY "Coinlabcoin project"
...
OutFile coinlabcoin-0.8.3r6-win32-setup.exe
InstallDir $PROGRAMFILES\Coinlabcoin
CRCCheck on
XPStyle on
BrandingText " "
ShowInstDetails show
VIProductVersion 0.8.3.6
VIAddVersionKey ProductName Coinlabcoin
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall Coinlabcoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Coinlabcoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Coinlabcoin.lnk"
